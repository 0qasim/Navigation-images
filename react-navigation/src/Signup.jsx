...
const Signup = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios
      .post("https://navigation-images-api.vercel.app/Signup", { name, email, password })
      .then((result) => {
        toast.success("Signup successful **Congratulations");

        console.log(result);
        setTimeout(() => {
          Navigate("/Signin"); // Redirect to the home page after a delay (in milliseconds)
        }, 3000);    return;
